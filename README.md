...
class Matt {
    public function __construct(
        public string $👨‍💼 = "Matthieu Werner",
        public string $🏢 = "Senior Software Engineer @Treezor", //
        public string $🎯 = "Focusing on Card Payment Architectures & FinOps", // New: Alignement
        public string $📢 = "Speaker & Mentor", // Update: More senior
        public string $🐘 = "PHP & Symfony enthusiast",
        public string $🏗️ = "Building scalable and resilient systems", // Value proposition
        public string $📫 = "Connect with me on LinkedIn",
    ) {
    }

    public function getLatestInsights(): string {
        return "Check my blog at blog.matthieu-werner.fr";
    }
}
```
